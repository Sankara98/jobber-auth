...
import { BadRequestError, IAuthDocument, isEmail } from '@sankara98/jobber-shared';
...
export async function read(req: Request, res: Response): Promise<void> {
  ...
  // get user data by email or name
  ...
  // Mathch the password  and return user without passoword
